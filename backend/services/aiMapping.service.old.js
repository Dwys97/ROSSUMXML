...
if (GEMINI_API_KEY && GEMINI_API_KEY !== 'YOUR_GEMINI_API_KEY_HERE') {
    // Try to initialize with specific configuration to use v1 API
    genAI = new GoogleGenerativeAI(GEMINI_API_KEY);
}

// Direct REST API approach using fetch
...
async function generateMappingSuggestion(sourceNode, targetNodes, context = {}) {
    ...
    try {
        console.log('🔧 Using direct REST API approach to bypass v1beta issue...');
