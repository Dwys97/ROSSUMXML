...
function LandingPage() {
	...
	return (
		...
		// 					<span className={`${styles.titleWord} ${styles.titleWordHighlight}`} style={{ animationDelay: "0.4s" }}>
		// 						EFFORTLESS
		// 					</span>
		// 					<span className={`${styles.titleWord} ${styles.heroSectionTitleWord}`} style={{ animationDelay: "0.9s" }}>
		// 						XML
		// 					</span>
		// 					<span className={`${styles.titleWord} ${styles.heroSectionTitleWord}`} style={{ animationDelay: "0.9s" }}>
		// 						INTEGRATION,
		// 					</span>
		// 					<span className={`${styles.titleWord} ${styles.titleWordHighlight}`} style={{ animationDelay: "1.4s" }}>
		// 						INSTANT
		// 					</span>
		// 					<span className={`${styles.titleWord} ${styles.heroSectionTitleWord}`} style={{ animationDelay: "1.9s" }}>
		// 						RESULTS
		// 					</span>
		// 				</h1>
		...
		// 					Eliminate weeks of manual XML integration work. Our platform automatically maps, validates, and transforms
		// 					complex data structures in <span className={styles.subtitleHighlight}>seconds, not months</span> — saving your
		// 					team thousands of hours on every integration project.
		// 				</p>
		...
		// 						<li className={styles.logoItem} aria-hidden="true">
		// 							Acme
		// 						</li>
		// 						<li className={styles.logoItem} aria-hidden="true">
		// 							Globex
		...
		// 				<p>
		// 					“SchemaBridge cut our onboarding from months to days. Our teams ship integrations 10x faster with full
		// 					auditability.”
		// 				</p>
		// 				<footer>
		...
		// 					<p>
		// 						SOC 2 Type II certified with end-to-end encryption, audit trails, and role-based access controls for
		...
		// 					<p>
		// 						Process large XML files up to 1GB with sub-second transformation times using our optimized processing engine
		...
		// 					<p>
		// 						RESTful APIs, webhooks, and SDKs for seamless integration with your existing enterprise systems and CI/CD
		// 						pipelines.
		// 					</p>
		// 					<div className={styles.featureGradient}></div>
		// 				</div>
		...
		// 					<p>
		// 						Real-time dashboards, comprehensive logging, and advanced analytics for monitoring transformation
