...
const TopNav = memo(function TopNav() {
	...
	return (
		<>
			<nav className="bg-gray-100 border-r border-r-gray-200 flex-row w-2/12 h-screen">
								...
								{!isAdminPage && (
									<>
										<div className="text-cyan-900 bg-white py-4 pl-6">
											<NavLink to="/" className="flex flex-row text-cyan-900" onClick={handleNavLinkClick}>
												<svg
													width="24"
													height="24"
													viewBox="0 0 24 24"
										...
										<div className="text-cyan-900 py-4 pl-6">
											<NavLink
												to="/"
												className="flex flex-row text-cyan-900"
												onClick={() => {
