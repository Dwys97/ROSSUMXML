...
function DestinationTemplateUpload({ onFileSelect, isDragActive = false }) {
	...
	return (
		<div className="flex flex-col gap-6">
			{/* Label */}
			<p className="font-sans font-medium text-lg leading-7 text-slate-700">
				Upload your destination template
			</p>
			...
			>
				...
				<div className="flex flex-col">
					<p className="font-sans font-light text-base leading-6 text-slate-700">
						Drop XML file here
					</p>
				</div>
